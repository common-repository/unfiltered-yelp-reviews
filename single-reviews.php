...
* UnFiltered
* Single review template. Copy into your Current Theme Folder.
* 
...
<br><br>
<h3 class="reviews-header ieSucks">Note: Many of the reviews below are "filtered" and have not been "factored" into Dempster Plumbing's overall star rating on Yelp.</h3>
...
<fb:like href="http://www.dempsterplumbing.com/reviews/<?php echo $reviewslug; ?>" send="true" layout="button_count" width="210" show_faces="false"></fb:like>
<br><br>
<g:plusone size="small" annotation="inline" href="http://www.dempsterplumbing.com/reviews/<?php echo $reviewslug; ?>"></g:plusone>
<br><br>
